...
void CaveGenerator::init(Map &map, int fillprob, generation_params *genParams, int generations)
{
    this->size_x = map.width;
    this->size_y = map.height;
...
int CaveGenerator::exportMap(const char *filename)
{
    return 0;
}
