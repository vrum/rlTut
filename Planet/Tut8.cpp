...
int main (int argc, char** argv)
{
	...
	renderer.AddGradientPoint (-0.9000, utils::Color (  0,   0, 255, 255)); // shallow
	renderer.AddGradientPoint (-0.7500, utils::Color (  0, 128, 255, 255)); // shore
	renderer.AddGradientPoint (-0.7250, utils::Color (240, 240,  64, 255)); // sand
	renderer.AddGradientPoint (-0.2250, utils::Color ( 32, 160,   0, 255)); // grass
	renderer.AddGradientPoint ( 0.7750, utils::Color (224, 224,   0, 255)); // dirt
